...
//Shuffles the set of cards, which is in an array.
 ...
 function checkMatch() {
   if ($('.open, .show').length == 2 ) {
     ...
     if(firstCard === secondCard) {
       ...
       //if there are 16 cards that have the .match class, displayScoreBoard
       if (numOfMatches === 16) {
         displayScoreBoard(numOfMoves);
       }
     } else {
       //no match on the cards
       $('.open, .show').each(function() {
         $(this).removeClass('open show');
